...
import { TileWonders } from '../../types/civTypes'

export const allWonderImages: Record<TileWonders, string> = 
{
    [TileWonders.ALHAMBRA]: alhambra,
    [TileWonders.BIG_BEN]: big_ben,
    [TileWonders.BOLSHOI_THEATRE]: bolshoi_theatre,
    [TileWonders.BROADWAY]: broadway,
    [TileWonders.CHICHEN_ITZA]: chichen_itza,
    [TileWonders.COLOSSEUM]: colosseum,
    [TileWonders.COLOSSUS]: colossus,
    [TileWonders.CRISTO_REDENTOR]: cristo_redentor,
    [TileWonders.EIFFEL_TOWER]: eiffel_tower,
    [TileWonders.ESTADIO_DO_MARACANA]: estadio_do_maracana,
    [TileWonders.FORBIDDEN_CITY]: forbidden_city,
    [TileWonders.GREAT_LIBRARY]: great_library,
    [TileWonders.GREAT_ZIMBABWE]: great_zimbabwe,
    [TileWonders.GREAT_LIGHTHOUSE]: great_lighthouse,
    [TileWonders.HAGIA_SOPHIA]: hagia_sophia,
    [TileWonders.HANGING_GARDENS]: hanging_gardens,
    [TileWonders.HERMITAGE]: hermitage,
    [TileWonders.HUEY_TEOCALLI]: huey_teocalli,
    [TileWonders.MAHABODHI_TEMPLE]: mahabodhi_temple,
    [TileWonders.MONT_ST_MICHEL]: mont_st_michel,
    [TileWonders.ORACLE]: oracle,
    [TileWonders.OXFORD_UNIVERSITY]: oxford_university,
    [TileWonders.PETRA]: petra,
    [TileWonders.POTALA_PALACE]: potala_palace,
    [TileWonders.PYRAMIDS]: pyramids,
    [TileWonders.RUHR_VALLEY]: ruhr_valley,
    [TileWonders.STONEHENGE]: stonehenge,
    [TileWonders.SYDNEY_OPERA_HOUSE]: sydney_opera_house,
    [TileWonders.TERRACOTTA_ARMY]: terracotta_army,
    [TileWonders.VENETIAN_ARSENAL]: venetian_arsenal
};