import { TileType, TileNone, TileFeatures, TileTerrain, TileWonders, TileDistricts, TileUniqueDistricts, TileNaturalWonders, TerrainFeatureKey, HexType } from "./types";
...
{
    if (tile.District === TileDistricts.CENTER_DISTRICT)                                    return {imgElement: districtMap.get(TileDistricts.CENTER_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.COMMERCIAL_DISTRICT)                           return {imgElement: districtMap.get(TileDistricts.COMMERCIAL_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.ENCAMPMENT_DISTRICT)                           return {imgElement: districtMap.get(TileDistricts.ENCAMPMENT_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.ENTERTAINMENT_DISTRICT || 
                tile.District === TileUniqueDistricts.STREET_CARNIVAL_DISTRICT)             return {imgElement: districtMap.get(TileDistricts.ENTERTAINMENT_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.HARBOR_DISTRICT || 
                tile.District === TileUniqueDistricts.ROYAL_NAVY_DOCKYARD_DISTRICT)         return {imgElement: districtMap.get(TileDistricts.HARBOR_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.FAITH_DISTRICT || 
                tile.District === TileUniqueDistricts.LAVRA_DISTRICT)                       return {imgElement: districtMap.get(TileDistricts.FAITH_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.THEATER_DISTRICT || 
                tile.District === TileUniqueDistricts.ACROPOLIS_DISTRICT)                   return {imgElement: districtMap.get(TileDistricts.THEATER_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.INDUSTRIAL_DISTRICT || 
                tile.District === TileUniqueDistricts.HANSA_DISTRICT)                       return {imgElement: districtMap.get(TileDistricts.INDUSTRIAL_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.NEIGHBORHOOD_DISTRICT || 
                tile.District === TileUniqueDistricts.MBANZA_DISTRICT)                      return {imgElement: districtMap.get(TileDistricts.NEIGHBORHOOD_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.AQUEDUCT_DISTRICT || 
                tile.District === TileUniqueDistricts.BATH_DISTRICT)                        return {imgElement: districtMap.get(TileDistricts.AQUEDUCT_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.ROCKET_DISTRICT)                               return {imgElement: districtMap.get(TileDistricts.ROCKET_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.AERODROME_DISTRICT)                            return {imgElement: districtMap.get(TileDistricts.AERODROME_DISTRICT), scaleType: HexType.DISTRICT};
    else if (tile.District === TileDistricts.SCIENCE_DISTRICT)                              return {imgElement: districtMap.get(TileDistricts.SCIENCE_DISTRICT), scaleType: HexType.DISTRICT};
