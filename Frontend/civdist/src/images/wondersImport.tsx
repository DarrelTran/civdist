...
import { ImageWondersType } from '../utils/types'

export const allWonderImages: Record<ImageWondersType, string> = 
{
    [ImageWondersType.ALHAMBRA]: alhambra,
    [ImageWondersType.BIG_BEN]: big_ben,
    [ImageWondersType.BOLSHOI_THEATRE]: bolshoi_theatre,
    [ImageWondersType.BROADWAY]: broadway,
    [ImageWondersType.CHICHEN_ITZA]: chichen_itza,
    [ImageWondersType.COLOSSEUM]: colosseum,
    [ImageWondersType.COLOSSUS]: colossus,
    [ImageWondersType.CRISTO_REDENTOR]: cristo_redentor,
    [ImageWondersType.EIFFEL_TOWER]: eiffel_tower,
    [ImageWondersType.ESTADIO_DO_MARACANA]: estadio_do_maracana,
    [ImageWondersType.FORBIDDEN_CITY]: forbidden_city,
    [ImageWondersType.GREAT_LIBRARY]: great_library,
    [ImageWondersType.GREAT_ZIMBABWE]: great_zimbabwe,
    [ImageWondersType.GREAT_LIGHTHOUSE]: great_lighthouse,
    [ImageWondersType.HAGIA_SOPHIA]: hagia_sophia,
    [ImageWondersType.HANGING_GARDENS]: hanging_gardens,
    [ImageWondersType.HERMITAGE]: hermitage,
    [ImageWondersType.HUEY_TEOCALLI]: huey_teocalli,
    [ImageWondersType.MAHABODHI_TEMPLE]: mahabodhi_temple,
    [ImageWondersType.MONT_ST_MICHEL]: mont_st_michel,
    [ImageWondersType.ORACLE]: oracle,
    [ImageWondersType.OXFORD_UNIVERSITY]: oxford_university,
    [ImageWondersType.PETRA]: petra,
    [ImageWondersType.POTALA_PALACE]: potala_palace,
    [ImageWondersType.PYRAMIDS]: pyramids,
    [ImageWondersType.RUHR_VALLEY]: ruhr_valley,
    [ImageWondersType.STONEHENGE]: stonehenge,
    [ImageWondersType.SYDNEY_OPERA_HOUSE]: sydney_opera_house,
    [ImageWondersType.TERRACOTTA_ARMY]: terracotta_army,
    [ImageWondersType.VENETIAN_ARSENAL]: venetian_arsenal
};